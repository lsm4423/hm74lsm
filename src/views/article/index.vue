<template>
  <div class="article-container">
    ...
    <el-card>
      ...
      <el-table :data="articles">
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            ...
            <el-tag v-if="scope.row.status === 4" type="danger"></el-tag>
          </template>
        </el-table-column>
      ...
      <div class="box">
        <el-pagination background layout="prev, pager, next" @current-change="pager" :page-size="reqParams.per_page" :total="total"></el-pagination>
      </div>
    </el-card>
  </div>
</template>
